...
which builds an `oauth2_authorization_code_flow` from individual
properties.
...
- x:
  ...
  with names "refresh_url", "scopes", "authorization_url", and/or
...
An `oauth2_authorization_code_flow` as returned by
[`class_oauth2_authorization_code_flow()`](https://rapid.api2r.org/reference/class_oauth2_authorization_code_flow.md).
