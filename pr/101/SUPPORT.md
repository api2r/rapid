# Getting help with rapid

Thanks for using rapid! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/jonthegeek/rapid/issues/new).
...
requests](https://github.com/jonthegeek/rapid/issues) to make sure the
